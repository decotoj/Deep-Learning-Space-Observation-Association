...
def survey(results, category_names):
    ...
    fig.suptitle('Number of Acquired RSOs in Test Set \n w/ Varying Number of Explored Triplet Search Solutions', fontsize=12)
    ax.set_ylabel('Number of Exlored Triplets from Search Space', fontsize='medium')   # relative to plt.rcParams['font.size']
